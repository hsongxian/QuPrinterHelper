//package com.qupai.lib_printer.hiti;
//
...
//
//    public PrinterOperation(Context context, ServiceConnector serviceConnector,int PaperType) {
//        mJobId = 101;
//        PRINTCOUNT = 1;
////        MATTE = 0; //1:matte 雾面效果, 0:notmatte 非雾面效果
//        MATTE = 0;
//        PRINTMODE = 1;
...
//
//        PrinterJob job = printerService(Action.USB_COMMAND_CLEAN_PAPER_PATH);
//        return job;
//    }
//
...
//
//
//                Bitmap bitmap = ImageUtils.getBitmap(String.valueOf(data));
//
//                if (bitmap == null) {
//
...
//                    switch (PaperType) {
//                        case 2:
//                            attr = PrintPara.getPrintPhotoPara(bitmap, PRINTCOUNT, MATTE, PRINTMODE, PrintPara.PaperSize.PAPER_SIZE_6X4_PHOTO, m_strTablesRoot);
//                            break;
//
//                        case 3:
//                            attr = PrintPara.getPrintPhotoPara(bitmap, PRINTCOUNT, MATTE, PRINTMODE, PrintPara.PaperSize.PAPER_SIZE_5X7_PHOTO, m_strTablesRoot);
//                            break;
//
//                        case 4:
//                            attr = PrintPara.getPrintPhotoPara(bitmap, PRINTCOUNT, MATTE, PRINTMODE, PrintPara.PaperSize.PAPER_SIZE_6X8_PHOTO, m_strTablesRoot);
//                            break;
//
//                        case 5:
//                            attr = PrintPara.getPrintPhotoPara(bitmap, PRINTCOUNT, MATTE, PRINTMODE, PrintPara.PaperSize.PAPER_SIZE_6X4_SPLIT_2UP, m_strTablesRoot);
//                            break;
//
//                        default:
//                            attr = PrintPara.getPrintPhotoPara(bitmap, PRINTCOUNT, MATTE, PRINTMODE, PrintPara.PaperSize.PAPER_SIZE_6X4_PHOTO, m_strTablesRoot);
...
//                    attr = PrintPara.getSetCommandPara((short) data);
//                break;
//
//            default:
//        }
